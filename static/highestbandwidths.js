...
//Layer with settings for when zoomed out. Makes high density of points blur into a bigger blob.
let IPheat =
    {
        "id": "IP-Heat",
        "type": "heatmap",
...
// Layer that sets the dots for when zoomed in
let IPpoint = {
    'id': 'IP-point',
    'type': 'circle',
    'source': sourceUse,
